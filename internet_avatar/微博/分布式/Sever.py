...
if __name__ == "__main__":
    ...
    username.send_keys("XXXXXXXXXX")  # 请在此输入用户名
    time.sleep(2)
    password = driver.find_element_by_name("password")
    password.send_keys("XXXXXXXXX")  # 请在此输入密码
    time.sleep(5)
    ...
    while True:
        try:
            ...
            for i in range(1, 6):
                ...
                imgurl = mytree.xpath("//*[@id=\"Pl_Official_HisRelation__61\"]/div/div/div/div[2]/div[1]/ul/li")  # 主页关注列表
                imgurl = imgurl[0]
