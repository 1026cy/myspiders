...
def get_page_title(url):
    ...
    for line in linelist:
        try:
            font = line.xpath('./p/a/font/text()')
            titlelist = line.xpath('./p/a/text()')
            if len(titlelist) == 1:
                title = font[0]+ font[1] + titlelist[0]
                resultlist.append(title)
            elif len(titlelist) == 2:
                title = titlelist[0] + font[0]+ font[1] + titlelist[1]
                resultlist.append(title)
            else:
                title = titlelist[0]+font[0]+titlelist[1]+ font[1] + titlelist[1]
                resultlist.append(title)
